...
data class CurrentConcept(
    ...
    constructor(dbo: BegrepDBO, latestPublishedId: String?) : this(
        ...
        dbo.status,
        dbo.statusURI,
        dbo.erPublisert == true,
        dbo.isArchived == true,
        dbo.publiseringsTidspunkt,
        dbo.anbefaltTerm,
        dbo.tillattTerm,
        dbo.frarådetTerm,
        dbo.definisjon,
        dbo.definisjonForAllmennheten,
        dbo.definisjonForSpesialister,
        dbo.merknad,
        dbo.merkelapp,
        dbo.ansvarligVirksomhet,
        dbo.eksempel,
        dbo.fagområde,
        dbo.fagområdeKoder?.filterNotNull(),
        dbo.omfang,
        dbo.kontaktpunkt,
        dbo.gyldigFom,
        dbo.gyldigTom,
        dbo.endringslogelement,
        dbo.opprettet,
        dbo.opprettetAv,
        dbo.seOgså,
        dbo.internSeOgså,
        dbo.erstattesAv,
        dbo.assignedUser,
        dbo.abbreviatedLabel,
        dbo.begrepsRelasjon,
        dbo.internBegrepsRelasjon,
        dbo.interneFelt,
        dbo.internErstattesAv,
        latestPublishedId,
    )

    fun toDTO(): Begrep = Begrep(
        id = idOfThisVersion,
        originaltBegrep = originaltBegrep,
        versjonsnr = versjonsnr,
        revisjonAv = revisjonAv,
        status = status,
        statusURI = statusURI,
        ...
        definisjonForAllmennheten = definisjonForAllmennheten,
        definisjonForSpesialister = definisjonForSpesialister,
        merknad = merknad,
        merkelapp = merkelapp,
