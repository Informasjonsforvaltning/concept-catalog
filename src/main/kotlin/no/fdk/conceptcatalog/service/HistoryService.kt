...
import no.fdk.conceptcatalog.model.HistoricPayload
...
@Service
class HistoryService(private val applicationProperties: ApplicationProperties, private val mapper: ObjectMapper) {
