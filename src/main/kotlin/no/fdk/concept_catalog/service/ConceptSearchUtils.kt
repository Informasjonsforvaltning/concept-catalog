...
fun orgFilter(orgNumber: String): Query = Query.of { queryBuilder ->
        ...
        queryFilters
            .add(
                Query.of { queryBuilder ->
                    queryBuilder.terms { termsBuilder ->
                        termsBuilder
                            .field("interneFelt.$key.value.keyword")
