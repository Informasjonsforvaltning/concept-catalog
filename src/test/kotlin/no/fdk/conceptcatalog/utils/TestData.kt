package no.fdk.conceptcatalog.utils
...
import no.fdk.conceptcatalog.model.Endringslogelement
import no.fdk.conceptcatalog.model.ForholdTilKildeEnum
import no.fdk.conceptcatalog.model.InterntFelt
...
import no.fdk.conceptcatalog.model.OpEnum
import no.fdk.conceptcatalog.model.SemVer
import no.fdk.conceptcatalog.model.Status
...
val BEGREP_WITH_CHANGE_REQUEST_TO_BE_DELETED =
    Begrep(
...
val BEGREP_UNPUBLISHED_REVISION =
    Begrep(
...
val BEGREP_UNPUBLISHED_REVISION_MULTIPLE_FIRST =
    Begrep(
...
val BEGREP_UNPUBLISHED_REVISION_MULTIPLE_SECOND =
    Begrep(
...
val CHANGE_REQUEST_6 =
    ChangeRequest(
        id = "cr6",
        conceptId = BEGREP_2.id,
        conceptSnapshot = BEGREP_2,
        catalogId = "123456789",
        status = ChangeRequestStatus.REJECTED,
        operations = listOf(),
        timeForProposal = ZonedDateTime.of(2019, 1, 1, 12, 0, 0, 0, ZoneId.of("Europe/Oslo")).toInstant(),
...
val CHANGE_REQUEST_UPDATE_BODY_NEW =
...
val CHANGE_REQUEST_UPDATE_BODY_UPDATE =
    ChangeRequestUpdateBody(
        conceptId = "123456789",
        operations =
        listOf(
...
val CHANGE_REQUEST_UPDATE_BODY_0 =
    ChangeRequestUpdateBody(
...
val CHANGE_REQUEST_TO_BE_DELETED =
    ChangeRequest(
        id = "cr6",
